...
def attack(char_name: str, char_class: str):
    """Функция нанесенного урона в зависимости от выбранного пути силы"""
...
def defence(char_name: str, char_class: str):
    """Функция блокировки урона в зависимости от выбранного пути силы"""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str):
    """Функция применения умения зависимости от выбранного пути силы"""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str):
    """Функция тренировки в зависимости от выбранного пути силы"""
    if char_class == 'warrior':
